...
root.title('Doc profile')
docimg=PhotoImage(file="C:\\Users\\Accer\\Desktop\\project\\sho.png")
Label(root,image=docimg).place(x=90,y=-10)
lbl=Label(root,text='Staff',bg='light gray',font=('Arial Bold',50)).pack()
